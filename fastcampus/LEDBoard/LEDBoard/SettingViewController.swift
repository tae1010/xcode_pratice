...
class SettingViewController: UIViewController {
    ...
    weak var ledBoardDelegate: LEDBoardSettingDelegate?
    var ledText: String?
    ...
    @IBAction func tabSaveButton(_ sender: UIButton) {
        self.ledBoardDelegate?.changedSetting(text: self.textField.text, textColor: self.textColor, backgroundColor: self.backgroundColor)
